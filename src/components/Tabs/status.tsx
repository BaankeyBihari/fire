...
export default function Record(props: any) {
  ...
  React.useEffect(() => {
    ...
    allThings.sort(compareInvestment);
    setPlan(allThings);
    const dateLabels = allThings.map((e) => e.recordDate.toDateString()).filter(onlyUnique).map((e) => new Date(e));
                        ...
                        datasets: [
                          ...plan.map((e: { tag: any; }) => e.tag)
                              ...
                              .reduce((p, e) => {
                                ...
                                const [borderColor, backgroundColor, cBorderColor, cBackgroundColor] = colorPalette.get(e);
                                return [
                                  ...p,
                                  {
                                    label: e + ':Invested',
                                    data: labels
                                        ...
                                        .map((el) => {
                                          const ik = values.findIndex((e) => e.recordDate.toDateString() === el.toDateString());
                        ...
                        <TableBody>
                          {
                            plan
                                ...
                                .filter((e) => {
                                  return e.tag === 'Planned' || e.recordDate < new Date();
                                })
